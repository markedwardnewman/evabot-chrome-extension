...
var Gmail_ = function(localJQuery) {
    ...
    */
    ...
    api.version = "0.6.4";
    api.tracker.globals = typeof GLOBALS !== "undefined" ? GLOBALS : (typeof(window) !== "undefined" && window.opener !== null && typeof window.opener.GLOBALS !== "undefined" ? window.opener.GLOBALS : []);
    api.tracker.view_data = typeof VIEW_DATA !== "undefined" ? VIEW_DATA : (typeof(window) !== "undefined" && window.opener !== null && typeof window.opener.VIEW_DATA !== "undefined" ? window.opener.VIEW_DATA : []);
    ...
    api.tools.parse_actions = function(params, xhr) {
        ...
        if (params.method === "POST" && (typeof params.url.SID === "string" || typeof params.url.ik === "string" || typeof params.url.act === "string")) {
    ...
    api.observe.register = function(action, args, parent) {
        ...
        if (parent) {
            if (!api.tracker.custom_dom_observers[parent]) {
                api.tracker.custom_dom_observers[parent] = {
                    sub_observers: {}
                };
            }
    ...
    */
    ...
    api.get.email_source_async = function(email_id, callback, error_callback, preferBinary) {
        api.get.email_source_promise(email_id, preferBinary).then(callback).catch(error_callback);
    };
